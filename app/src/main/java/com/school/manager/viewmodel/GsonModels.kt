...
internal data class GsonTeacher(val id: Long? = null, val name: String? = null, val gender: String? = null, val phone: String? = null, val avatarUri: String? = null, val code: String? = null)
internal data class GsonClass(val id: Long? = null, val name: String? = null, val grade: String? = null, val count: Int? = null, val headTeacherId: Long? = null, val subjectId: Long? = null, val code: String? = null)
internal data class GsonLesson(val id: Long? = null, val classId: Long? = null, val date: String? = null, val startTime: String? = null, val endTime: String? = null, val status: String? = null, val topic: String? = null, val notes: String? = null, val attendees: List<Long>? = null, val isModified: Boolean? = null, val code: String? = null, val teacherIdOverride: Long? = null, val knowledgePointIds: List<Long>? = null)

internal data class GsonKpChapter(
    val id: Long? = null, val grade: String? = null, val no: Int? = null, val name: String? = null
)
internal data class GsonKpSection(
    val id: Long? = null, val chapterId: Long? = null, val no: Int? = null, val name: String? = null
)
...
internal fun parseGsonState(json: String, gson: Gson, pathRemap: Map<String, String> = emptyMap()): AppState? {
    return try {
